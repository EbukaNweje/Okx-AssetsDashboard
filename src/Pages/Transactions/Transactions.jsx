...
const Transactions = () => {
    ...
    const url = `https://okx-assets-back-end.vercel.app/api/getalldeposit/${id}`
    const url2 = `https://okx-assets-back-end.vercel.app/api/getallwithdrawal/${id}`
    const url3 = `https://okx-assets-back-end.vercel.app/api/getalltransactions/${id}`
