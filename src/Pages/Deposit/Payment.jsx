...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BITCOINP PAYMENT"? ("bc1qdg0mvuud5qq3933r7y6v8s2x20fgq0ldsfc5uy"): paymentname === "ETHEREUM PAYMENT"? ("0xf0d3E618F77642c32Cded583Eb000e4cA8f76FbB"): paymentname ==="USDT PAYMENT"? ("0xf0d3E618F77642c32Cded583Eb000e4cA8f76FbB"): "Chosse a Payment Method"}`,
        copied: false,
      });
